...
header("Location: profile_panels/student_profile_panel/index_student.php");
}
...
VALUES ('$new_user', '$new_pass', '$new_email', 1)";
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
							...
							<img src="assets/img/backgrounds/stud_pic.png" class="img-fluid" alt="Responsive image">
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="login_student.php" method="post" class="login-form">
