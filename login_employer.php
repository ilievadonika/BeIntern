...
header("Location: profile_panels/employer_profile_panel/index_employer.php");
}
...
VALUES ('$new_user', '$new_pass', '$new_email', 2)";
...
<html lang="en">
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
							...
							<img src="assets/img/backgrounds/emp_pic.png" class="img-fluid" alt="Responsive image">
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="login_employer.php" method="post" class="login-form">
        ...
        <script src="assets/js/scripts_emp.js"></script>
