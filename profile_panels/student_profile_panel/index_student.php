...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>&nbsp;Hello ! </b>Welcome Back <b> <?php echo $user_data['First_Name'] . ' ' . $user_data['Last_Name'] ; ?> &nbsp;&nbsp;</b> 
							<i class="fa  fa-pencil"></i><b>&nbsp;3 </b>Pending Offers to Answere. 
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="alert alert-warning text-center">
                        <i class="fa  fa-pencil fa-3x"></i>&nbsp;<b>3</b>  Pending offers to answere
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
					<img src="assets/img/welcome_picture.png" alt style="width: 700px">
