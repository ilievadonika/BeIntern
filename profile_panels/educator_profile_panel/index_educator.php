<?php
	...
	$query = "SELECT * FROM educator_data WHERE user_id= '$userid'";
	...
	if($_SESSION['profile_type'] == 1){
		header("Location: ../student_profile_panel/index_student.php");		
	}else if ($_SESSION['profile_type'] == 2)
	{
		header("Location: ../employer_profile_panel/index_employer.php");
	}
...
<head>
    ...
    <title>BeIntern.com - Educator profile</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div class="navbar-header">
				...
				<div class="logo_text">Educator <span>   Profile</span>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                        ...
                        <div class="user-section">
						   ...
						   <?php
								if($row['picture'] != ""){
									...
									?>
									<img src="assets/img/educator_icon.jpg" alt="">
									<?php		
								}						   
						   ?>
			            </div>
					...
					<li class="selected">
                        <a href="#"><i class="fa fa-dashboard fa-fw"></i>Educator Presentation</a>
                    </li>
					<li class= "active">
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Add Personal Information</a>   
                    </li>
					<li class= "active">
					...
					<li class= "active">
                        <a href="#"><i class="fa fa-suitcase fa-fw"></i>My Interns</a>   
                    </li>
                    <li class= "active">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>&nbsp;Hello ! </b>Welcome Back <b> <?php echo $user_data['First_Name'] . ' ' . $user_data['Last_Name'] ; ?> &nbsp;&nbsp;</b> 
							<i class="fa  fa-pencil"></i><b>&nbsp;3 </b>Pending Messages to Answere. 
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="alert alert-danger text-center">
                        <i class="fa fa-calendar fa-3x"></i>&nbsp;<b>Мonthly Schedule</b><br>20 Events this Month

                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="alert alert-success text-center">
                        <i class="fa fa-laptop fa-3x"></i>&nbsp;<b>58% Complete Profile</b><br>Give some more information
                    </div>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <div class="alert alert-warning text-center">
                        <i class="fa  fa-pencil fa-3x"></i>&nbsp;<b>10</b> Pending applications to answere
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
					<img src="assets/img/welcome_pic.jpg" alt style="width: 700px">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-pencil-square-o fa-fw"></i>New Intenship Offer
